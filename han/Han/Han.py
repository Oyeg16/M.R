...
cl = Han.LINE()
cl.login(token="EmQiUhMFAn997ZsttgS1.zPxGhBCCuRt+GUvuSuF0Sq.n5Vl0tDaSDofSV+vAA7NXIEyF7oQpcZiv1qyQ1ZrMJY=")
cl.loginResult()

ki = Han.LINE()
ki.login(token="Emn1oXkOWZ4zWuCyDqX9.lvhTHvJhuqU+eY3EkInGgq.SxEblH8G6PJ+oxDyMKbDdhMXs2T8pw/pGWG5xh56gZ8=")
ki.loginResult()

ki2 = Han.LINE()
ki2.login(token="EmmexCMfCtXo1lwN9lp7.etshjDGzlBiwhahkrczQbW.knntmYU8HRsX1UQ1Pagh7VGZWW1YfpIJ7+VwUKkngT0=")
ki2.loginResult()
...
􀜁􀇔􏿿 [Staff add/remove @]
    ✯==== Creator ====✯
	           <Han_Bot>
  http://line.me/ti/p/~calonjodohku
"""
helo=""
...
admsa = "u6695e01db71c52b4ff82e554b147f4b1"
admin = "u6695e01db71c52b4ff82e554b147f4b1,u34a8cc290fee32b9e186309f6c9e25b7"
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"Buakakakakak, rename lu talal ?",
    "lang":"JP",
...
def bot(op):
    try:
        ...
        if op.type == 25:
                     ...
                     if msg.from_ in admin:
                         ...
                         for s in groups.members:
                             if _name in s.displayName:
                                 cl.sendText(msg.to,"-> " + _name + " sdh dsni han")
                                 break
                             elif invite in wait["blacklist"]:
                                 ki.sendText(msg.to,"Gausah, " + _name + " dia msk list banned")
            ...
            elif msg.text in ["Han1 Gift","Han1 gift"]:
                msg.contentType = 9
            ...
            elif msg.text in ["Han2 Gift","Han2 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': '3b92ccf5-54d3-4765-848f-c9ffdc1da020',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '3'}
...
#---------------------------------------------------------
              ...
              if msg.from_ in admin:
            ...
            elif msg.text.lower() == 'han1 group id':
                gid = ki.getGroupIdsJoined()
                h = ""
                for i in gid:
                    h += "[%s]:%s\n" % (ki.getGroup(i).name,i)
                ki.sendText(msg.to,h)    
            elif msg.text in ["Han out all gc"]:
                gid = cl.getGroupIdsJoined()
                gid = ki.getGroupIdsJoined()
                ...
                for i in gid:
                    ...
                    ki2.leaveGroup(i)
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"HanBot Done kluar smua gc")
                else:
...
#-----------------------------------------------------------
                ...
                start = time.time()
                cl.sendText(msg.to, "Han_Bot..........%")
                elapsed_time = time.time() - start
                cl.sendText(msg.to, "%sseconds" % (elapsed_time))
                start = time.time()
                ki.sendText(msg.to, "Han_Bot1....................%")
                elapsed_time = time.time() - start
                ki.sendText(msg.to, "%sseconds" % (elapsed_time))
                start = time.time()
                ki2.sendText(msg.to, "Han_Bot2.............................%")
                elapsed_time = time.time() - start
 ...
 #------------------------------------------------------------------
              ...
              if msg.toType == 2:
                ...
                if msg.toType == 2:
                    ...
                    gs = ki.getGroup(msg.to)
                    gs = ki2.getGroup(msg.to)
                    ki.sendText(msg.to,"Simisi tod ")
                    ki2.sendText(msg.to,"--------------")
                    ki2.sendText(msg.to,"Gosah panic")
                    targets = []
                    for g in gs.members:
                        if _name in g.displayName:
                            targets.append(g.mid)
                    if targets == []:
                        ki.sendText(msg.to,"Gada mem pekok.")
                        ki2.sendText(msg.to,"Gada mem pekok.")
                    else:
                        for target in targets:
...
#-----------------------------------------------
            ...
            elif "Han say " in msg.text:
				bctxt = msg.text.replace("Han say ","")
     ...
     for zx in range(0,500):
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
          try:    
            ...
            cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"ᴬ̙ᵘ̙ᵗ̙ᵒ̙ˡ̙ⁱ̙ᵏ̙ᵉ̙ ᵇ̙ʸ̙ 🚩آB̶uͤrͭhͦa̶̶ͩn̶̅🕷┯")
            ki.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"ᴬ̙ᵘ̙ᵗ̙ᵒ̙ˡ̙ⁱ̙ᵏ̙ᵉ̙ ᵇ̙ʸ̙ 🚩آB̶uͤrͭhͦa̶̶ͩn̶̅🕷┯")
            ki2.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki2.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"ᴬ̙ᵘ̙ᵗ̙ᵒ̙ˡ̙ⁱ̙ᵏ̙ᵉ̙ ᵇ̙ʸ̙ 🚩آB̶uͤrͭhͦa̶̶ͩn̶̅🕷┯")
            ki3.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki3.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"ᴬ̙ᵘ̙ᵗ̙ᵒ̙ˡ̙ⁱ̙ᵏ̙ᵉ̙ ᵇ̙ʸ̙ 🚩آB̶uͤrͭhͦa̶̶ͩn̶̅🕷┯")
